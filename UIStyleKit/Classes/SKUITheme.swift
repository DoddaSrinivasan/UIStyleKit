...
extension UIView {
    ...
    internal func font(_ type: String?) -> String {
        ...
        for key: String in SKUITheme.appearance().fonts.keys {
            if(key.lowercased() == type?.lowercased()){
                fontName = SKUITheme.appearance().fonts[key]!
                break
            }
        }
    ...
    internal func color(_ type: String) -> UIColor? {
        ...
        for key: String in SKUITheme.appearance().colors.keys {
            if(key.lowercased() == type.lowercased()){
                color = SKUITheme.appearance().colors[key]!
                break
            }
        }
